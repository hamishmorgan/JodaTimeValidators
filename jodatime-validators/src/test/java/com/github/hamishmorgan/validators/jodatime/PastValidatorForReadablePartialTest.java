...
public class PastValidatorForReadablePartialTest {
    ...
    @InjectMocks
    private PastValidatorForReadablePartial validator;
    ...
    @Test
    public void givenLocalDateIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenLocalDateIsInTheFuture_whenIsValid_thenReturnFalse() {
    ...
    @Test
    public void givenLocalDateTimeIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenLocalDateTimeIsInTheFuture_whenIsValid_thenReturnFalse() {
    ...
    @Test
    public void givenLocalTimeIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenMonthDayIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenMonthDayIsInTheFuture_whenIsValid_thenReturnFalse() {
        DateTime now = currentDateTimeSupplier.get();
    ...
    @Test
    public void givenTimeOfDayIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenTimeOfDayIsInTheFuture_whenIsValid_thenReturnFalse() {
    ...
    @Test
    public void givenYearMonthIsInThePast_whenIsValid_thenReturnTrue() {
        DateTime now = currentDateTimeSupplier.get();
    ...
    @Test
    public void givenYearMonthIsInTheFuture_whenIsValid_thenReturnFalse() {
        DateTime now = currentDateTimeSupplier.get();
    ...
    @Test
    public void givenYearMonthDayIsInThePast_whenIsValid_thenReturnTrue() {
    ...
    @Test
    public void givenYearMonthDayIsInTheFuture_whenIsValid_thenReturnFalse() {
